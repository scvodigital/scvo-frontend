                    ...
                    text: [
                        { text: 'Minimum: ', bold: true }, {
                            text: fund.minimumAwardSize ?
                                fund.minimumAwardSize.toLocaleString('en-GB', { style: 'currency', currency: fund.currencyCode }) :
                                'No minimum provided'
                        }
                    ]
                },
                    ...
                    text: [
                        { text: 'Maximum: ', bold: true }, {
                            text: fund.maximumAwardSize ?
                                fund.maximumAwardSize.toLocaleString('en-GB', { style: 'currency', currency: fund.currencyCode }) :
                                'No maximum provided'
                        }
                    ]
                },
                    ...
                    text: [
                        { text: 'Average: ', bold: true }, {
                            text: fund.averageAwardSize ?
                                fund.averageAwardSize.toLocaleString('en-GB', { style: 'currency', currency: fund.currencyCode }) :
                    ...
                    text: [
                        { text: 'Anuallly awarded: ', bold: true }, {
                            text: fund.annualTotal ?
                                fund.annualTotal.toLocaleString('en-GB', { style: 'currency', currency: fund.currencyCode }) :
    ...
    return new Promise(function (resolve, reject) {
        ...
        request.get(getOptions, function (err, resp, body) {
            ...
            if (!body.hits || body.hits.total === 0 || !body.hits.hits)
                return reject(body);
            var funds = body.hits.hits.map(function (hit) {
                return hit._source;
            });
            resolve(funds);
        });
